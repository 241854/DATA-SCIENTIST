...
# UI
ui <- dashboardPage(
  dashboardHeader(title = "METODI DI CLASSIFICAZIONE IN MACHINE LEARNING"),
  dashboardSidebar(
    sidebarMenu(
      menuItem("Home", tabName = "home"),
      menuItem("Clustering", tabName = "clustering"),
      menuItem("Download", tabName = "download"),
      menuItem("Autore:AZEMFACK PAGES AIME", tabName = "Autore:AZEMFACK PAGES AIME")
    )
  ),
  dashboardBody(
    tabItems(
                ...
                tags$div(
                  ...
                  tags$div(
                    ...
                    tags$div(
                      class = "col-md-12",
                      align = "center",
                      tags$h2("2 metodi di raggruppamento in classificazione"),
                      tags$p("NB: il file è in inglese"),
                      tags$h3("Autore:"),
                      tags$ul(
                        tags$li("AZEMFACK PAGES AIME"),
